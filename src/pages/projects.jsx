...
class Projects extends Component {
  ...
  projectSelect(element) {
    ...
    for (var x = 0; x < element.length; x++) {
      ...
      } else if (element[x] === "flask") {
        tools.push(
          <img
            class="tools-img"
            src={require("../Images/Icons/skills/Flask.png")}
            alt="pic"
          />
        );
      ...
      } else if (element[x] === "jquery") {
        tools.push(
          <img
            class="tools-img"
            src={require("../Images/Icons/skills/jQuery.png")}
            alt="pic"
          />
        );
                ...
                <div class="row justify-content-center">
                  <div class="scroll-button-proj">
                    <Link
                      ...
                      duration={1400}
                    >
                    <div class="button-dark-orange">Take a look!</div>
                    </Link>
                  </div>
                </div>
              </div>
